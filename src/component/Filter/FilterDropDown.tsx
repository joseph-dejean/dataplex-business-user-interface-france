...
import FilterGlossaryIcon from '../../assets/svg/glossary_icon.svg';
...
const FilterDropdown: React.FC<FilterProps> = ({ filters , onFilterChange, isGlossary = false, onClose }) => {
 ...
 let assets:any = {
  ...
  const [filterData, setFilterData] = useState<any[]>(
    isGlossary
      ? [products, assets, glossaries, projects]
      : [products, assets, glossaries, annotations, projects]
  );
  ...
  useEffect(() => {
    ...
    setFilterData(
      isGlossary
        ? [products, assets, glossaries, newProjects]
        : [products, assets, glossaries, annotations, newProjects]
    );
                      ...
                      <FormControlLabel
                        ...
                        label={
                          <div style={{
                            ...
                            {(filter.title === 'Assets' || filter.title === 'Glossaries') && isGlossaryAssetType(item.name) && (
